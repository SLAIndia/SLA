...
;webshims.register('form-message', function($, webshims, window, document, undefined, options){
	...
	webshims.createValidationMessage = function(elem, name){
		...
		if("valueMissing"===name){
			message=(inputName in CMSGl_Data.fieldvals)?
	    			CMSGl_Data.fieldvals[inputName]["valueMissing"]:
	    			CMSGl_Data.fieldvals.com["valueMissing"];
		} else if("typeMismatch"===name){
			message=CMSGl_Data.fieldvals.com["invalidInput"];
		} else if("patternMismatch"===name){
			message=(inputName in CMSGl_Data.fieldvals)?
	    			CMSGl_Data.fieldvals[inputName]["pattern"]:
	    				CMSGl_Data.fieldvals.com.pattern.password;
		}
